...
void EDITOR::build_and_run_file()
{
    ...
    char *_thisFile_ = new char[this_file.size()+1];
    std::copy(this_file.begin(), this_file.end(), _thisFile_);
    _thisFile_[this_file.size()] = '\0';
    //std::cout<<"path= "<<_thisDir_<<std::endl;
    //std::cout<<"file= "<<_thisFile_<<std::endl;
